...
# ============================================
# STEP 5 — SSL (first run only)
# ============================================
echo "→ Checking SSL certificate ..."
$SSH "sudo certbot --nginx -d ${DOMAIN} -d www.${DOMAIN} --non-interactive --agree-tos -m admin@equivaafrica.org || echo 'Certbot skipped or already done.'"

# ============================================
# STEP 6 — SEED .env IF MISSING
# ============================================
$SSH bash <<REMOTE
